...
readseg(uintptr_t va, uint32_t count, uint32_t offset) {
    ...
    7c7b:	8d 04 10             	lea    (%eax,%edx,1),%eax
    7c7e:	89 45 f0             	mov    %eax,-0x10(%ebp)

    // round down to sector boundary
    va -= offset % SECTSIZE;
    7c81:	89 c8                	mov    %ecx,%eax
    7c83:	31 d2                	xor    %edx,%edx
    7c85:	f7 35 dc 7d 00 00    	divl   0x7ddc
...
waitdisk(void) {
    ...
    7cdc:	8b 0d dc 7d 00 00    	mov    0x7ddc,%ecx
    7ce2:	c1 e9 02             	shr    $0x2,%ecx
    return data;
}
...
insl(uint32_t port, void *addr, int cnt) {
    ...
    // we load in increasing order.
    for (; va < end_va; va += SECTSIZE, secno ++) {
    7cef:	03 35 dc 7d 00 00    	add    0x7ddc,%esi
    7cf5:	43                   	inc    %ebx
...
bootmain(void) {
    ...
    7d03:	a1 dc 7d 00 00       	mov    0x7ddc,%eax
    7d08:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    7d0f:	31 c9                	xor    %ecx,%ecx
    7d11:	a1 d8 7d 00 00       	mov    0x7dd8,%eax
    7d16:	e8 57 ff ff ff       	call   7c72 <readseg>

    // is this a valid ELF?
    if (ELFHDR->e_magic != ELF_MAGIC) {
    7d1b:	a1 d8 7d 00 00       	mov    0x7dd8,%eax
    ...
    7d28:	8b 58 1c             	mov    0x1c(%eax),%ebx
    7d2b:	01 c3                	add    %eax,%ebx
    eph = ph + ELFHDR->e_phnum;
    7d2d:	0f b7 70 2c          	movzwl 0x2c(%eax),%esi
    ...
    7d3a:	8b 4b 04             	mov    0x4(%ebx),%ecx
    7d3d:	8b 53 14             	mov    0x14(%ebx),%edx
    7d40:	8b 43 08             	mov    0x8(%ebx),%eax
    7d43:	25 ff ff ff 00       	and    $0xffffff,%eax
    7d48:	e8 25 ff ff ff       	call   7c72 <readseg>
    struct proghdr *ph, *eph;
    ...
    7d52:	a1 d8 7d 00 00       	mov    0x7dd8,%eax
